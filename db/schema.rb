...
ActiveRecord::Schema.define(version: 2019_06_17_115313) do
  ...
  create_table "activity_posts", force: :cascade do |t|
    ...
    t.index ["category_id"], name: "index_activity_posts_on_category_id"
    t.index ["user_id"], name: "index_activity_posts_on_user_id"
  end

  create_table "activity_users", force: :cascade do |t|
    t.bigint "activity_post_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["activity_post_id"], name: "index_activity_users_on_activity_post_id"
  ...
  add_foreign_key "activity_posts", "categories"
  add_foreign_key "activity_posts", "users"
  add_foreign_key "activity_users", "activity_posts"
